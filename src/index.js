...
// Функція, що виконується при перетині елементом зони видимості "Елемент перетинає зону видимості" означає, 
//що елемент стає видимим на екрані користувача, входячи в видиму область сторінки. 
//Це може статися, наприклад, коли користувач прокручує сторінку і долає до певного місця, де знаходиться цей елемент.
